        ...
        if(strpos($register, '"otp_token"')){
			...
			if(strpos($verif, '"access_token"')){
				...
				if(strpos($code1, 'You can use this promo now...')){
					...
					sleep(3);
					$boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOODSENANG12"}');
					...
					goride:
					echo "\n".color("yellow","!] Claim Voc PAKEKGOJEK20");
					echo "\n".color("yellow","!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
					...
					sleep(3);
					$goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PAKEKGOJEK20"}');
